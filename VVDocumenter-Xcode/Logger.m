...
- (void) forwardInvocationForLogger:(NSInvocation*) invocation{
    ...
    NSString* forward = [NSString stringWithFormat:@"LOGGER_HIDDEN_%@", NSStringFromSelector([invocation selector]) ];
...
+ (void) registerTracing:(NSString*)name{
    ...
    for( unsigned int i = 0 ; i < num ; i++ ){
        ...
        NSString* new_selector = [NSString stringWithFormat:@"LOGGER_HIDDEN_%@", NSStringFromSelector(selector)];
